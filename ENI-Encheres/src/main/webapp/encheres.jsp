	                ...
	                <c:forEach var="article" items="${tousArticles}">
						...
						<div class="item-info-allAuctions">	
							...
							<div class="item-container">
								...
								<fieldset class="auction-info-dates">
									...
									<div class="auctiontimeContent">
										...
										<p class="articleContent">
											...
											<span class="title-detailItem-lessWide">Début de l'enchère :</span>
											Le 
										...
										<p class="articleContent">
											...
											<span class="title-detailItem-lessWide">Fin de l'enchère :</span> 
											Le
								...
								<p class="articleContent"><span class="title-detailItem">Prix Initial :</span><span class="prixInit"> ${article.prixInit} points</span>
		                            
								<div class="deliveryAdress">
									<p class="articleContent"><span class="title-detailItem-lessWide">Livraison (Adresse de retrait) :</span> ${article.adresseRetrait}</p>
								</div>
